 ...
 */
@WebServlet(name = "EstudianteCursoInfo", urlPatterns = {"/EstudianteCursoInfo"})
public class EstudianteCursoInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int notaid = Integer.parseInt(request.getParameter("Nota"));
            
            Estudiante estudiante = new Estudiante();
            
            if (request.getParameter("action").equals("Add")) {
                estudianteCursoFacade.insertarEstudianteCurso(cursoid, estudianteid, notaid);
            }
